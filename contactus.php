...
$email_name = isset($email_name) ? htmlspecialchars(trim($email_name)) : "";
  $email_email = isset($email_email) ? htmlspecialchars(trim($email_email)) : "";
  $email_msg = isset($email_msg) ? htmlspecialchars(trim($email_msg)) : "";
  $email_subject = isset($email_subject) ? htmlspecialchars(trim($email_subject)) : "";
  $sec_string = isset($sec_string) ? $sec_string : "";
  $send_done = isset($send_done) ? $send_done : false;
