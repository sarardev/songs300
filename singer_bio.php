...
//---------------------------------------------------------
   ...
   print "<div class='singer-page singer-bio-page'><div class='singer-page-shell'><div class='singer-page-path'>";
...
print "<section class='singer-content-card singer-bio-card'>";
