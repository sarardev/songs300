...
if ($id){
  ...
  print "<div class='news-page news-inside-page'><div class='news-page-shell'><div class='news-page-path'>";
  ...
  print "</div>";
      ...
      print "<section class='news-content-card news-article-card'>";
      open_table($data['title']);
     run_template('browse_news_inside');
     close_table();
     print "</section>";
     }else{
     print "<div class='news-page news-inside-page'><div class='news-page-shell'><section class='news-content-card news-article-card'>";
     open_table();
...
if($settings['enable_news_comments']){
    print "<section class='news-content-card news-comments-card'>";
...
print "</div></div>";
  ...
  if(!is_array($cat_name)){$cat_name = array();}
  $cat_path = "";
  if(isset($cat_name['name']) && $cat_name['name']){
      $cat_path = " $phrases[path_sep] <a class='path_link' href=\"".str_replace("{cat}",$cat,$links['browse_news'])."\" title=\"".$cat_name['name']."\">".$cat_name['name']."</a>";
  }
  print "<div class='news-page news-list-page'><div class='news-page-shell'><div class='news-page-path'>";
  print "<span class='path'><img src=\"images/arrw.gif\">&nbsp;<a class='path_link' href=\"".$links['news']."\" title=\"$phrases[the_news]\">$phrases[the_news]</a> $cat_path<br><br></span>";
  print "</div>";
...
templates_cache(array('news_cats_header','news_cats_sep','news_cats','news_cats_footer'));
 ...
 print "<section class='news-content-card news-cats-card'>";
...
$qr = db_query("select * from songs_news where cat='$cat' order by id DESC limit $start,$news_perpage");
  ...
  print "<section class='news-content-card news-listing-card'>";
