...
<textarea name='value' rows=10 cols=30>$field_value</textarea></td></tr>

<tr><td><b>$phrases[addition_style]</b> </td><td><input type=text size=30  name='style_v' value=\"$field_style\" dir=ltr></td></tr>
