...
//----------------------------------------------------
 ...
 if($settings['enable_search']){ 
        ...
        if(strlen($keyword) >= $settings['search_min_letters']){
              ...
              print "<div class='search-page'><div class='search-page-shell'>";
              
                compile_hook('search_start');   
       print "<section class='search-content-card search-results-card'>";
...
//----------------
         ...
         print "<div class='search-page'><div class='search-page-shell'><section class='search-content-card search-results-card'>";
         open_table();
