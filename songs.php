...
//----------------------------------------------------
 ...
 if(!$op){
   ...
   $songs_page_opened = true;
   print "<div class='songs-page singer-songs-page'><div class='songs-page-shell'><div class='songs-page-path'>";
  ...
  if($album_id == 0){
   ...
   print "<section class='songs-hero-card'>";
...
//----------------------- END SINGER TABLE ---------------------------------
  ...
  print "<section class='songs-content-card songs-albums-card'>";
  open_table();
